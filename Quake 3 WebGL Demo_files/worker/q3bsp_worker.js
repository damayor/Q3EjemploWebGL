 ...
 */
  ...
  /***
 CVI - Script publico que decodifica todo el contenido el archivo BSP para leerlo en WebGL
 ***/
...
CVI - lee y guarda todas las lumps del archivo BSP. Más información en http://www.mralligator.com/q3/
...
CVI - Entidades de la escena como nombres, lugares, armas, luces, etc.
...
CVI - En este caso son las mismas texturas de algúna figura
...
CVI - Cada vertice que compone una cara. Posición, coordenadas de la textura, normal y color.
...
CVI - Describe cualquier superficie del mapa. Tiene atributos como la texturas, la normal, y los vertices que la componen.
...
CVI - Plano que va a ser referenciado por brushSides. Compuesto por una normal y la distancia desde el centro del 
        espacio.
**/
...
CVI - Rama que compone el arbol BSP (Binary Space Partioning) que determina que regiones pueden verse desde cualquier posicion 
        a partir de coordenadas minimas y maximas. Mas información en:
        http://jheriko-rtw.blogspot.com.co/2010/04/visibility-testing-and-bsp-trees.html
**/
...
CVI - Bloques concavos para determinar colliders (paredes o piso)
...
CVI - Cada pared de cada brush. Compuesto por 
        - un plano
        - una textura
